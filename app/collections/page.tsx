  ...
  return (
    <div className="shell section-air">
      ...
      <h1 style={{ marginBottom: "1.5rem" }}>
        Collections for a considered wardrobe.
      </h1>
      <p
        style={{
          fontSize: "1.05rem",
      ...
      <div className="collections-list">
        ...
        <div className="collection-row" id="the-atelier-edit">
          ...
          <div className="collection-row-content">
            ...
            <div className="collection-row-actions">
              <a className="btn-capsule" href="/products/the-tailored-blazer">
                The Tailored Blazer
              </a>
              <a className="btn-capsule" href="/products/the-longline-coat">
                The Longline Coat
              </a>
            </div>
          </div>
        ...
        <div className="collection-row" id="enduring-essentials">
          ...
          <div className="collection-row-content">
            ...
            <div className="collection-row-actions">
              <a className="btn-capsule" href="/products/the-silk-blouse">
                The Silk Blouse
              </a>
              <a className="btn-capsule" href="/products/the-evening-knit-set">
                The Evening Knit Set
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="collection-row" id="evening">
          ...
          <div className="collection-row-content">
            ...
            <div className="collection-row-actions">
              <a className="btn-capsule" href="/products/the-satin-slip-dress">
